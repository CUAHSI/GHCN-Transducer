    ...
    <div id="content">
      ...
      <div class="heading1">  <asp:Label CssClass="heading1" ID="PageTitle" runat="server" Text="Web Service"></asp:Label>
       ...
       <div class="intro">
            ...
            to provide access to data from the <a href="www.ncdc.noaa.gov/data-access/land-based-station-data/land-based-datasets/global-historical-climatology-network-ghcn"
                target="_blank"><span style="color: #0000ff">Global Historical Climate Network - Daily</span></a><br />
            quality controlled climate observation data <strong>
                <br />
            </strong>
